...
public enum ModToolMaterials implements ToolMaterial {
    ELECTRIFIED_COPPER_INGOT(ModTags.Blocks.INCORRECT_FOR_ELECTRIFIED_COPPER_INGOT_TOOL,
            3000, 10.0F, 5.0F, 22, () -> Ingredient.ofItems(ModItems.ELECTRIFIED_COPPER_INGOT));
